const {getPositions, getBrokrage, getFunds, exitAll, cancelAll, exitPosition, cancelOrder, stoploss, placeOrder } = require('../Controllers/tradingConsole')
...
router.post("/get-positions",getPositions)
